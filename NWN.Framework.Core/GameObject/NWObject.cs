...
namespace NWN.Framework.Core.GameObject
{
    public class NWObject
    {
        ...
        {
            if (Object == null || Object == _.OBJECT_TYPE_INVALID)
        ...
        {
            get => _.GetDescription(Object, _.FALSE, _.FALSE);
            set => _.SetDescription(Object, value, _.FALSE);
        }
        ...
        public virtual int Gold
        {
            ...
            set
            {
                AssignCommand(() =>
                {
                    _.TakeGoldFromCreature(Gold, Object, _.TRUE);
        ...
        public virtual void SpeakString(string message, int talkVolume = _.TALKVOLUME_TALK)
        {
        ...
        public virtual bool IsCreature => _.GetObjectType(Object) == _.OBJECT_TYPE_CREATURE;

        public virtual IEnumerable<NWItem> InventoryItems
        {
            get
            {
                if (_.GetHasInventory(Object) == _.FALSE)
                {
                    throw new Exception("Object does not have an inventory.");
                }
                
                for (NWItem item = _.GetFirstItemInInventory(Object); _.GetIsObjectValid(item) == _.TRUE; item = _.GetNextItemInInventory(Object))
                {
                    yield return item;
                }
            }
        ...
        public virtual IEnumerable<Effect> Effects
        {
            get
            {
                for (Effect effect = _.GetFirstEffect(Object); _.GetIsEffectValid(effect) == _.TRUE; effect = _.GetNextEffect(Object))
                {
                    yield return effect;
                }
            }
        ...
        public void RemoveEffect(int effectTypeID)
        {
            ...
            while (_.GetIsEffectValid(effect) == _.TRUE)
            {
